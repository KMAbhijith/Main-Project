                ...
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <h4>Lab Tests (Patients Count)</h4>
                            <hr>
                            <div class="card" style="padding:25px;border-radius:25px;">
                                <h5>Yearly Report</h5>
                                <hr>
                                <form method="POST" action="labreport.php" class="from-control was-validated">
                                    ...
                                    <br>
                                    <button class="form-control btn btn-primary" type="submit" name="yrlabdoc">Generate</button>
                                </form>
                            </div>
                            <br>
                            <div class="card" style="padding:25px;border-radius:25px;">
                                ...
                                <form method="POST" action="labreport.php" class="from-control was-validated">
                                    ...
                                    <br>
                                    <button class="form-control btn btn-primary" type="submit" name="mnlabdoc">Generate</button>
                                </form>
                            </div>
