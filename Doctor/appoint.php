                                ...
                                <div class="card" style="padding:25px;border-radius:25px;">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            $sdle = mysqli_query($con, "select *,TIME_FORMAT(s.S_Time,'%r') AS stime from booking b,schedule s,doctor d,patient p where   b.P_id= p.P_id  and d.D_id=$fd[D_id] and b.D_id=$fd[D_id] and b.S_id=s.S_id and s.W_day=CURDATE() order by b.tokenno  ");
