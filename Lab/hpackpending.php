    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                $sel = mysqli_query($con, "select * from healthpackage h,hpack_book hpb,patient p where  hpb.P_id=p.P_id and  h.HP_id=hpb.HP_id and hpb.status=1");
                    ...
                    <div class="card " style="padding:25px;">
                        <table class="table">
                            ...
                            ?><tr>
                                    ...
                                    <td><a class="btn btn-primary" href='hbooksuploadfile.php?hpb=<?php echo  $d['HPB_id'] ?>&hp=<?php echo  $d['HP_id'] ?>'>Upload Report</a></td>
                                <tr>
                                <?php
                            }
                                ?>
