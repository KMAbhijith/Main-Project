    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                $sel = mysqli_query($con, "select * from labrefassign tr,booking b,patient p,doctor d where  b.P_id=p.P_id and b.D_id=d.D_id and tr.B_id=b.B_id and  tr.B_id=tr.B_id and LA_resultstatus=1");
                    ...
                    <div class="card " style="padding:25px;">
                        <table class="table">
                            ...
                            ?><tr>
                                    ...
                                    <td><a class="btn btn-primary" href='uploadfile.php?lba=<?php echo  $d['LA_id'] ?>&bid=<?php echo $d['B_id'] ?>'>Upload Result</a></td>
                                <tr>
                                <?php
                            }
                                ?>
