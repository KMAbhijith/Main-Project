            ...
            <div class="container-fluid">
                ...
                <div class="card " style="padding:25px;">
                    <table class="table">
                        ...
                        <?php
                        $sel = mysqli_query($con, "select * from labrefassign tr,booking b,patient p,doctor d where  b.P_id=p.P_id and b.D_id=d.D_id and tr.B_id=b.B_id and  tr.B_id=tr.B_id and LA_resultstatus=0");
                        ...
                        ?><tr>
                                ...
                                <td><a class="btn btn-danger" href='uploadsample.php?lba=<?php echo  $d['LA_id'] ?>'>Collect</a></td>
                            <tr>
                            <?php
                        }
                            ?>
