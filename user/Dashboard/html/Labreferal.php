            ...
            <div class="page-wrapper">
                ...
                <div class="page-breadcrumb">
                    <div class="row align-items-center">
                        <div class="col-6">
                            ...
                            <h1 class="mb-0 fw-bold">Lab Records</h1>
                        </div>
                        <div class="col-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?php
                            $sel = mysqli_query($con, "select * from labrefassign tr,booking b,patient p,doctor d where  b.P_id=$r11[P_id] and p.P_id=$r11[P_id]  and b.D_id=d.D_id and tr.B_id=b.B_id and  tr.B_id=tr.B_id and LA_resultstatus=2");
                                ...
                                <div class="card " style="padding:25px;">
                                    <table class="table">
                                        ...
                                        ?><tr>
                                                ...
                                                <td><a class="btn btn-primary" href="report.php?la=<?php echo $d['LA_id'] ?>">View</a></td>
                                            <tr>
                                            <?php
                                        }
                                            ?>
